...
interface TMDbService {
    ...
    @GET("movie/{id}?api_key=$API_KEY&language=en-US" +
            "&append_to_response=release_dates,credits,videos,reviews,recomendations,similar")
    ...
    @GET("tv/{id}?api_key=$API_KEY&language=en-US" +
            "&append_to_response=content_ratings,credits,videos,reviews,recomendations,similar")
